...
//    ///For INPUT:
//        int windows , doors;            ///Amount of windows/doors
//        double length, width, costonetube, lengthtube;
    //For calculation:
    ...
    // -------------------------TEST---------------------  28 chars for double because of 10 max + 16 after Dot. + '\0' + '.'
    ///For INPUT:
...
//    ///For calculation:
//        char amountoftubes[11], amountofgluepacks[11]; ///(int)
//        char squareall[28], squareneed[28], squareonetube[28], totalcost[28]; ///(double)
//    ///Tempuary:
//        char temp1[28], temp2[28]; ///(double)
    ...
    while (1){
        ...
        case 7:
            if (lengthtube[0]!='n' && length[0]!='n' && width[0]!='n' && windows[0]!='n' && doors[0]!='n')
            {
                ...
                temp1 = squareneed / squareonetube;
            ...
            break;
        case 8:
            if (lengthtube[0]!='n' && length[0]!='n' && width[0]!='n' && windows[0]!='0' && doors!='n')
            {
